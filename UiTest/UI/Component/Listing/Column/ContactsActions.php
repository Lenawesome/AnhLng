<?php
namespace AnhLng\UiTest\Ui\Component\Listing\Column;
        ...
        if(isset($dataSource['data']['items'])) {
            foreach($dataSource['data']['items'] as &$item)
            {
                $item[$this->getData('name')]['edit'] = [
                    'href' => $this->urlBuilder->getUrl('uitest/index/edit', ['id' => $item['contact_id']]),
                    'label' => __('Edit'),
                    'hidden' => false
                ];
                $item[$this->getData('name')]['delete'] = [
                    'href' => $this->urlBuilder->getUrl('uitest/index/delete', ['id' => $item['contact_id']]),
                    'label' => __('Delete'),
                    'hidden' => false
                ];
            }
